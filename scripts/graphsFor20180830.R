...
march <- subset(allPaired, datetimeFM>=lubridate::ymd_hm('2014-03-22 06:00') & 
                  datetimeFM<=lubridate::ymd_hm('2014-03-22 20:00'))
...
plot(k$VPDair~k$datetimeFM, ylab='VPD (kPa)', xlab='', type='l', lwd=2, cex.lab=1.5)
...
plot(k$Cin~k$datetimeFM, type= 'l', ylim=c(min(k$Ci, na.rm=T), 1200), ylab='[CO2] ppm', xlab='', lwd=2, col='green', main='Ch 9 22 March 2014')
...
par(mar=c(0,6,2,2))
plot(k$gsc_area~k$datetimeFM, col='blue', pch=19, cex.lab=1.6, axes= F, ylab='')
