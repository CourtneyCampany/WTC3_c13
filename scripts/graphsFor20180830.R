...
plot(subset(march, chamber==chAmb[1])[,'gsc_area']~subset(march, chamber==chAmb[1])[,'datetimeFM'], pch=19,col=palAmb[1],axes=F, ylab='', 
     ylim=c(0, max(march$gmes_area, na.rm=T)), main='Amb T', xlim=ymd_hm(c('2014-03-22 06:00','2014-03-23 22:00')))
...
plot(subset(march, chamber==chAmb[1])[,'gmes_area']~subset(march, chamber==chAmb[1])[,'datetimeFM'], pch=19,col=palAmb[1],axes=F, ylab='',
      ylim=c(0, max(march$gmes_area, na.rm=T)), xlim=ymd_hm(c('2014-03-22 06:00','2014-03-23 22:00')))
...
box()
for(i in 2:length(chAmb)){
  points(subset(march, chamber==chAmb[i])[,'gsc_area']~subset(march, chamber==chAmb[i])[,'datetimeFM'], col=palAmb[i], pch19)
}
par(mar=c(4,6,0,2))
