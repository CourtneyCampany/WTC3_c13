...
# at 25 C and taking into account finite gmes according to Way et al. 2019 (Figure 4b)
gamma25 <- 46
# calculate Gamma Star for any leaf temp temperature
# Use parameters from fitted line in graph 4a in Way et al. New Phytol.
calcGammaStar <- function(gamma25, temp){
  gammaStar <- gamma25 + 2.39*(temp-25) + 0.067*(temp-25)
  return(gammaStar)
}
