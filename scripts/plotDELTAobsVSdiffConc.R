...
abline(quantile(allPaired$DELTAobs, prob=0.05, na.rm=T)*1000, 0, lty=2)
abline(quantile(allPaired$DELTAobs, prob=0.95, na.rm=T)*1000, 0, lty=2)
lines(x=c(10,10,10), y=c(-1000, 0, 1000), col='blue')
lines(x=c(25,25,25), y=c(-1000, 0, 1000), col='deeppink')
lines(x=c(35,35,35), y=c(-1000, 0, 1000), col='darkgrey')
lines(x=c(50,50,50), y=c(-1000, 0, 1000), col='darkolivegreen4')
